...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      {!isLoading && (
        <div className="relative flex flex-col items-center justify-center min-h-screen p-4 sm:p-6 md:p-8 rounded-lg shadow-lg overflow-hidden fade-in-slide mt-[-50px]">
          <h1
          ...
          <div className="flex flex-col md:flex-row items-center mt-8">
            ...
            <div className="md:ml-8 text-center md:text-left">
              ...
              <p className="text-white mt-4 text-sm sm:text-base md:text-lg">
                Explore the mysteries of planetary seismology through our
                cutting-edge web app, designed to analyze and identify seismic
                quakes from historic data collected during the Apollo missions
                and the Mars InSight Lander. With the challenge of limited data
                transfer from distant planets, our innovative algorithms and
                manual detection methods help scientists focus on the seismic
                signals that matter.
              </p>
              ...
              <p className="text-white mt-4 text-sm sm:text-base md:text-lg">
                Maximizing the value of seismic data is critical for planetary
                exploration, given the limitations in transmitting data from
                distant bodies. By refining algorithms to filter noise from
                seismic signals, we can ensure only the most scientifically
                relevant data is sent back to Earth. Whether through advanced
                algorithm development or manual analysis, the goal is to enhance
                data accuracy and efficiency, supporting future missions and
                contributing to a deeper understanding of planetary seismic
                activity.
              </p>
            </div>
          </div>
