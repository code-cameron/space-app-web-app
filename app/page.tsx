...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-start min-h-screen bg-backgroundTwo p-4 bg-grey rounded-lg shadow-lg">
      ...
      <div className="flex flex-col md:flex-row items-center mt-8">
        ...
        <div className="md:ml-8 text-center md:text-left">
          ...
          <h3 className="text-white text-xl mb-2 mt-6">
